# JournoTrail - Your Ultimate Travel Blog 🌍✈️

JournoTrail is a simple MERN travel blog website ✈ This project is aimed to help people to contribute in open source, upskill in react and also master git.

![Preview Image](https://github.com/krishnaacharyaa/journotrail/assets/116620586/17ba9da6-225f-481d-87c0-5d5a010a9538)

#

# JournoTrail Mega Project End to End Implementation
...
<img src="https://github.com/DevMadhup/JournoTrail-Mega-Project/blob/main/Assets/DevSecOps%2BGitOps.gif" />
...
- <b id="EKS">Create EKS Cluster on AWS (Master machine)</b>
  ...
  ```bash
  eksctl create cluster --name=journotrail \
                      --region=us-east-2 \
                      --version=1.30 \
                      --without-nodegroup
  ```
  ...
  ```bash
  eksctl create nodegroup --cluster=journotrail \
                       --region=us-east-2 \
                       --name=journotrail \
                       --node-type=t2.large \
                       --nodes=2 \
...
- <b>Create a <mark>JournoTrail-CI</mark> pipeline</b>
  ![image](https://github.com/user-attachments/assets/55c7b611-3c20-445f-a49c-7d779894e232)

#

- <b>Create one more pipeline <mark>JournoTrail-CD</mark></b>
...
- <b> Go to Master Machine and add our own eks cluster to argocd for application deployment using cli</b>
  ...
  ```bash
  argocd cluster add JournoTrail@journotrail.us-west-1.eksctl.io --name journotrail-eks-cluster
  ```

  > [!Tip] > JournoTrail@journotrail.us-west-1.eksctl.io --> This should be your EKS Cluster Name.
...
```bash
eksctl delete cluster --name=journotrail --region=us-west-1
```
